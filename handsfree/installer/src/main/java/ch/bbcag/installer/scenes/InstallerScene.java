...
public class InstallerScene extends HandsFreeScene {
    ...
    public InstallerScene(Stage stage, HandsFreeSceneConfiguration configuration) {
        ...
        borderPane.setPadding(new Insets(Const.BOX_PADDING_TOP_BOTTOM, Const.BOX_PADDING_RIGHT_LEFT, Const.BOX_PADDING_TOP_BOTTOM, Const.BOX_PADDING_RIGHT_LEFT));
    ...
    public void addIconImageBackground() {
        ...
        ImageView imageView = new ImageView(new Image(Start.class.getResourceAsStream("/images/icon128.png")));
