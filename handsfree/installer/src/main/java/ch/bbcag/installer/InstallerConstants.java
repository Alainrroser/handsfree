...
public class InstallerConstants extends Constants {

    public static final double WIDTH = 800;
    public static final double HEIGHT = 400;

    public static final double BOX_SPACING = 20;
    public static final int BOX_PADDING_TOP_BOTTOM = 50;
    public static final int BOX_PADDING_RIGHT_LEFT = 100;
